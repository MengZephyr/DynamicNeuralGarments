...
saveRoot = 'D:/models/NR/Data/ver_6/case_1/multiLaces/v_hdr/'
...
for fID in FrameID:
    ...
    offSetList = readList('D:/models/NR/Data/ver_6/case_1/cList/' + str(fID+1).zfill(7) + '.txt')
    numView = len(offSetList)
    
    for vID in range(numView):
        C.view_layer.objects.active = CameraBox
            
        C.object.constraints["Follow Path"].offset_factor = offSetList[vID]
